...
if (qrcdr()->getConfig('pdf') == true) { ?>
    <li class="nav-item<?php echo $alignnavitems; ?>">
        <a class="nav-link<?php if ($getsection == "#pdf") echo " active"; ?><?php echo $rounded_btn_nav; ?>" href="#pdf" role="tab" data-bs-toggle="tab"><i class="fa fa-file"></i> <span class="d-inline-block d-sm-inline-block">PDF</span></a>
    </li>
<?php
}
?>
