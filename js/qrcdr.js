    ...
    $.fn.extend({
        ...
        qrcdr: function(options) {
            ...
            return this.each(function() {
                ...
                formOnInput = obj.find('.qrcdr-form :input[type="text"], .qrcdr-form textarea, #file_name');
                formOnChange = obj.find('.qrcdr-form :input:not([type="text"]):not(textarea), .qrcolorpicker :input, #file_name');
                ...
                function updateCode() {
                    ...
                    timer = setTimeout(function(){
                        ...
                        preloader.fadeIn(100, function(){
                            ...
                            var sendata = 'section=' + section + '&file_name=' + fileName + '&';

                            let file = null;
                            let formData = new FormData();

                            if (section === '#pdf') {
                                file = sendIputs.prop('files')[0];
                            ...
                            if (section === '#pdf') {
                                sendata.split('&').forEach(item => {
                                    let itemArray = item.split('=');
                                    let key = itemArray[0];
                                    let value = decodeURIComponent(itemArray[1]);
